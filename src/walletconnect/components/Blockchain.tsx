...
import { AccountAction, ellipseAddress, AccountBalances, ChainMetadata, ChainNamespaces } from '../helpers';
...
const Blockchain: FC<PropsWithChildren<BlockchainProps>> = (props: PropsWithChildren<BlockchainProps>) => {
    ...
    const assets = typeof account !== 'undefined' && typeof balances !== 'undefined' ? balances[account] : [];
    return (
        <React.Fragment>
            <SAccount
                rgb={chain.meta.rgb}
